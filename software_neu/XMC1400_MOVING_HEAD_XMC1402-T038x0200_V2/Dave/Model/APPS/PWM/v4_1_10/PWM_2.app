...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PWM" URI="http://resources/4.1.10/app/PWM/2" description="Generates a PWM using one timer slice of CCU4 or CCU8" mode="NOTSHARABLE" version="4.1.10" minDaveVersion="4.3.2" instanceLabel="PWM_LED_3" appLabel="" containingProxySignal="true">
  ...
  <hwResources name="CC8 Slice" URI="http://resources/4.1.10/app/PWM/2/hwres_ccu8_cc8_slice" resourceGroupUri="peripheral/ccu8/*/cc8/*" mResGrpUri="peripheral/ccu8/*/cc8/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/ccu80/ccu80_0.dd#//@provided.12"/>
  </hwResources>
  <hwResources name="CC4 Slice" URI="http://resources/4.1.10/app/PWM/2/hwres_ccu4_cc4_slice" resourceGroupUri="" required="false" constraintType="NONE" mResGrpUri="peripheral/ccu4/*/cc4/*"/>
  ...
  <hwResources name="PWM Output Pin" URI="http://resources/4.1.10/app/PWM/2/__pin_hwres_port_pad_pwm_out" resourceGroupUri="devicepackage/0/*" mResGrpUri="devicepackage/0/*">
